...
function EditStudent() {
    ...
    useEffect(() => {
        Axios.get("https://crud-backend-deployment.onrender.com/studentRoute/update-student/" + id)
            .then((res) => {
    ...
    const handleSubmit = () => {
        ...
        Axios.put("https://crud-backend-deployment.onrender.com/studentRoute/update-student/" + id, dataToUpdate)
            .then((res) => {
                if (res.status === 200) {
